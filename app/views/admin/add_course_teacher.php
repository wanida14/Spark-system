  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <form method="post" action="../../src/Admin/Teacher/process_add_course_teacher.php" enctype="multipart/form-data" style="margin:40px 20px;">
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <a class="btn btn-outline-danger" href="teacher_course.php?id=<?php echo $id ?>" role="button"><i class="fas fa-ban fa-lg icon"></i>ยกเลิก</a>
        </form>
      </div>
    </div>
  </div>
