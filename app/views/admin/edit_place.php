...
<body>
  <?php
    ...
    if ($_GET) {
        ...
        $place = mysqli_fetch_array($result3);
      }
  ?>
  <!-- menu bar -->
  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <!-- content -->
      <div class="col-sm-10">
        <h1 class="text-center">แก้ไขสถานที่</h1>
        <form method="post" action="../../src/Admin/process_update_place.php" enctype="multipart/form-data" style="margin:40px 20px;">
          <div class="form-row">
            <div class="col form-group col-md-6">
              <label for="inputEmail4">ชื่อสถานที่</label>
              <input id="name" type="text" name="name" class="form-control" value="<?php echo $place["name"]; ?>">
          ...
          <a class="btn btn-outline-danger" href="add_place.php" role="button"><i class="fas fa-ban fa-lg icon"></i>ยกเลิก</a>
        </form>
