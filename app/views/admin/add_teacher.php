...
<body>
  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <!-- content -->
      <div class="col-sm-10">
        <h1 class="text-center">เพิ่มข้อมูลครู</h1>
        <form method="post" action="../../src/Admin/Teacher/process_add_teacher.php" enctype="multipart/form-data" style="margin:40px 20px;">
          <div class="form-row">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input id="facebook" type="text" name="facebook" class="form-control" placeholder="Facebook">
            </div>
            <div class="form-group col-md-6">
              <label for="inputPassword4">Line ID</label>
              <input id="lindID" type="text" name="lindID" class="form-control" placeholder="Line ID">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="inputEmail4">Birthday</label>
              <input id="birthday" type="date" name="birthday" class="form-control" placeholder="Birthday">
            </div>
            <div class="form-group col-md-6">
              <div class="form-group">
          ...
          <a class="btn btn-outline-danger" href="teacher.php" role="button"><i class="fas fa-ban fa-lg icon"></i>ยกเลิก</a>
        </form>
      </div>
    </div>
  </div>
...
<script> 
    $(document).ready(function(){
        $('#save').click(function(e){
            ...
            if (name == '' || nickname == '' || username == '' || password == '' || email == '' || tel == '' || address == '' || facebook == '' || lindID == '' || birthday == '' || myfile == '') {
