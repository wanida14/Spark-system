  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <form method="post" action="../../src/Admin/process_update_course.php" enctype="multipart/form-data" style="margin:40px 20px;">
          <div class="form-row">
            <div class="col form-group col-md-6">
              <label for="inputEmail4">ชื่อคอร์ส</label>
              <input id="name" type="text" name="name" class="form-control" value="<?php echo $subject["name"]; ?>">
              <input type="hidden" name="id" value="<?php echo $subject["id"]; ?>">
            </div>
            <div class="col form-group col-md-6">
              <label for="inputEmail4">ราคา</label>
              <input id="price" type="text" name="price" class="form-control" value="<?php echo $subject["price"]; ?>">
            </div>
          </div>

          <div class="form-group">
            <label for="inputAddress">รายละเอียด</label>
            <input id="detail" type="text" name="detail" class="form-control" value="<?php echo $subject["detail"]; ?>">
          </div>
          
          <button id="save" type="submit" class="btn btn-outline-info"><i class="fas fa-save fa-lg icon"></i>บันทึก</button>
          <a class="btn btn-outline-danger" href="course.php" role="button"><i class="fas fa-ban fa-lg icon"></i>ยกเลิก</a>
        </form>
      </div>
    </div>
  </div>
