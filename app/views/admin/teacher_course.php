      ...
      <div class="col-sm-10 ">
        <div class="row" style="margin-top:30px;">
          <div class="col-sm-12 text-right">
            <a class="btn btn-outline-success" href="add_course_teacher.php?id=<?php echo $id ?>" role="button"><i class="fas fa-plus-circle fa-lg icon"></i>เพิ่มคอร์ส</a>
          </div>
        </div>
        <div class="row">
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_array($result2)) {
                    echo "<tr>";
                        ...
                        echo "<td class=\"button-style\" style=\"width: 334px;\">
                                  <a href=\"datas_course_teacher.php?id={$row["id"]}\" class='btn btn-outline-info'>
                                  <i class='fas fa-address-book fa-lg icon'></i>ดูข้อมูล</a>
                                  <a href=\"report_teacher.php?student_id={$row["student_id"]}&subject_id={$row["id"]}&teacher_id={$row["teacher_id"]}\" class='btn btn-outline-success'>
                                  <i class='far fa-file-alt fa-lg icon'></i>Report</a> 
                                  <a href=\"../../src/Admin/Teacher/process_delete_course_teacher.php?id={$row["id"]}&teacher_id={$row["teacher_id"]}\" class='btn btn-outline-danger'>
        ...
        <a class="btn btn-outline-success" href="teacher.php?id=<?php echo $id; ?>" role="button"><i class="fas fa-arrow-alt-circle-left fa-lg icon"></i>ย้อนกลับ</a>
      </div>
    </div>
  </div>
