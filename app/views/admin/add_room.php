  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <form method="post" action="../../src/Admin/process_add_room.php" enctype="multipart/form-data" style="margin:40px 20px;">
          <div class="form-row">
            <div class="col form-group col-md-6">
              <label for="inputEmail4">ชื่อห้อง</label>
              <input id="name" type="text" name="name" class="form-control" placeholder="Name room">
            </div>
            <div class="col form-group col-md-6">
