  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <h1 class="text-center">บันทึกหลังการสอน</h1>
          <form method="post" action="../../src/Admin/teacher/process_add_report.php" enctype="multipart/form-data" style="margin:40px 20px;">
            ...
            <div class="form-group col-sm-12" style="padding-left:0px;">
              ...
              <textarea id="report" type="text" name="report" class="form-control" rows="10"></textarea>
            </div>
            <button id="save" type="submit" class="btn btn-outline-info">
              <i class="fas fa-save fa-lg icon"></i>บันทึก</button>
            <a class="btn btn-outline-danger" href="report_teacher.php?student_id=<?php echo $student_id ?>&teacher_id=<?php echo $teacher_id ?>&subject_id=<?php echo $subject_id ?>" role="button">
