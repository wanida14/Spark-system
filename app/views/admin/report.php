    ...
    <div class="row">
      ...
      <div class="col-sm-12">
            ...
            <div class="form-row" style="margin-top:30px;">
              <div class="col form-group col-md-12">
                <a class="btn btn-outline-warning" href="edit_report.php?id=<?php echo $data_report["report_id"]; ?>&subject_id=<?php echo $subject_id ?>&teacher_id=<?php echo $teacher_id ?>&student_id=<?php echo $data_report["student_id"]; ?>" role="button">
                  <i class="fas fa-edit fa-lg icon"></i>แก้ไข</a>
                <a class="btn btn-outline-danger" href="../../src/Admin/teacher/process_delate_report.php?id=<?php echo $data_report["report_id"]; ?>&student_id=<?php echo $data_report["student_id"]; ?>&subject_id=<?php echo $subject_id ?>&teacher_id=<?php echo $teacher_id ?>" role="button">
                  <i class="fas fa-trash-alt fa-lg icon"></i>ลบ</a>
                <a class="btn btn-outline-danger" href="report_teacher.php?student_id=<?php echo $data_report["student_id"]; ?>&teacher_id=<?php echo $teacher_id ?>&subject_id=<?php echo $subject_id ?>" role="button">
