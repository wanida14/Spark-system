...
<body>
  <?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT  student_subject.time AS time, 
      ...
      <div class="col-sm-10 ">
        <div class="row" style="margin-top:30px;">
          <div class="col-sm-12 text-right">
            <a class="btn btn-outline-success" href="add_course_student.php?id=<?php echo $id ?>" role="button"><i class="fas fa-plus-circle fa-lg icon"></i>เพิ่มคอร์ส</a>
          </div>
        </div>
        <div class="row">
                ...
                while ($row = mysqli_fetch_array($result2)) {
                    echo "<tr>";
                        ...
                        echo "<td class=\"button-style\" style=\"width: 254px;\">
                                  <a href=\"datas_course_student.php?id={$row["id"]}\" class='btn btn-outline-info'>
                                  <i class='fas fa-address-book fa-lg icon'></i>ดูข้อมูล</a> 
                                  <a href=\"../../src/Admin/Student/process_delete_course_student.php?id={$row["id"]}&student_id={$row["student_id"]}\" class='btn btn-outline-danger'>
        ...
        <a class="btn btn-outline-success" href="student.php?id=<?php echo $id; ?>" role="button"><i class="fas fa-arrow-alt-circle-left fa-lg icon"></i>ย้อนกลับ</a>
      </div>
    </div>
  </div>
