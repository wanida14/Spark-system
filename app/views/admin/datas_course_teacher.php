      ...
      <div class="col-sm-10">
        ...
        <form style="margin-left:40px; font-size:25px;">
          ...
          <div class="form-group" style="margin:40px 0px;">
            <a class="btn btn-outline-warning" href="edit_course_teacher.php?id=<?php echo $teacher_sub["t_sub_id"]; ?>" role="button"><i class="fas fa-edit fa-lg icon"></i>แก้ไขข้อมูล</a>
