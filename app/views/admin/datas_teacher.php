...
<body>
  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="card">
          <h5 class="card-header">ข้อมูลครู</h5>
          <div class="card-body">
          <div class="row">
          <div class="col-sm-12 text-right">
            <?php
              echo '<img src ="../../src/Admin/Teacher/images/' . $teacher["picture"] . '" width="150" height="150">';
            ?>
          </div>
        </div>
        <form style="margin-left:40px; font-size:25px;">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <?php echo $teacher["facebook"]; ?>
            </div>
            <div class="form-group col-md-6">
              <label>Line ID : </label>
              <?php echo $teacher["lindID"]; ?>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
          ...
          <div class="form-group" style="margin:40px 0px;">
            <a class="btn btn-outline-warning" href="edit_teacher.php?id=<?php echo $teacher["id"]; ?>" role="button"><i class="fas fa-edit fa-lg icon"></i>แก้ไขข้อมูล</a>
            <a class="btn btn-outline-success" href="teacher.php?id=<?php echo $teacher["id"]; ?>" role="button"><i class="fas fa-arrow-alt-circle-left fa-lg icon"></i>ย้อนกลับ</a>
          </div>
        </div>
          </div>
        </div>
