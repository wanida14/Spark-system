      ...
      <div class="col-sm-10 ">
        <div class="row" style="margin-top:30px;">
          <div class="col-sm-12 text-right">
            <a class="btn btn-outline-info" href="add_teacher.php" role="button"><i class="fas fa-user-plus fa-lg icon"></i>เพิ่มครู</a>
          </div>
        </div>
        <div class="row">
            ...
            <table class="table text-center">
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_array($result2)) {
                    echo "<tr>";
                        echo "<td>" . $i . "</td>";
                        echo '<td><img src ="../../src/Admin/Teacher/images/' . $row["picture"] . '" height="50" width="50"></td>';
                        echo "<td>" . $row["name"] . "</td>";
                        echo "<td>" . $row["nickname"] . "</td>";
                        echo "<td class=\"button-style\">
                                  <a href=\"datas_teacher.php?id={$row["id"]}\" class='btn btn-outline-info'>
                                  <i class='fas fa-address-book fa-lg icon'></i>ดูข้อมูล</a>
                                  <a href=\"teacher_course.php?id={$row["id"]}\" class='btn btn-outline-success'>
                                  <i class='fas fa-book-open fa-lg icon'></i>คอร์ส</a>  
                                  <a href=\"../../src/Admin/Teacher/process_delete_teacher.php?id={$row["id"]}\" class='btn btn-outline-danger'>
