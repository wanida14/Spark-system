  ...
  ?>
      ...
      <div class="container pt-4">
        <div class="row">
          ...
          <!-- content -->
          <div class="col-sm-10">
            <h1 class="text-center">เพิ่มสถานที่</h1>
            <form method="post" action="../../src/Admin/process_add_place.php" enctype="multipart/form-data" style="margin:40px 20px;">
              <div class="form-row">
                <div class="col form-group col-md-6">
                  <label for="inputEmail4">ชื่อสถานที่</label>
                  <input id="name" type="text" name="name" class="form-control" placeholder="name place">
                </div>
              </div>
              <button id="save" type="submit" class="btn btn-outline-info">
                <i class="fas fa-save fa-lg icon"></i>บันทึก</button>
              <a class="btn btn-outline-danger" href="room.php" role="button">
                <i class="fas fa-ban fa-lg icon"></i>ยกเลิก</a>
            </form>

            <div class="row">
              <div class="col-sm-12 table-style">
                <h1 class="text-center">สถานที่ปัจุบัน</h1>
                  ...
                  while ($row = mysqli_fetch_array($result2)) {
                    echo "<tr>";
                      ...
                      echo "<td class=\"button-style\">
                              <a href=\"edit_place.php?id={$row["id"]}\" class='btn btn-outline-warning'>
                              <i class='fas fa-edit fa-lg icon'></i>แก้ไข</a>  
                              <a href=\"../../src/Admin/process_delete_place.php?id={$row["id"]}\" class='btn btn-outline-danger'>
