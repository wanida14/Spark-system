      ...
      <div class="col-sm-10 ">
        <div class="row" style="margin-top:30px;">
          <div class="col-sm-12 text-right">
            <a class="btn btn-outline-success" href="add_course.php" role="button"><i class="fas fa-plus-circle fa-lg icon"></i>เพิ่มคอร์ส</a>
          </div>
        </div>
        <div class="row">
            ...
            <table class="table text-center">
              <thead>
                <tr style="background-color:#a29bfe">
                  ...
                  <th style="width: 224px;">ชื่อคอร์ส</th>
                  <th>ราคา</th>
                ...
                while ($row = mysqli_fetch_array($result2)) {
                  echo "<tr>";
                    ...
                    echo "<td class=\"button-style\">
                              <a href=\"edit_course.php?id={$row["id"]}\" class='btn btn-outline-warning'>
                              <i class='fas fa-edit fa-lg icon'></i>แก้ไข</a>  
                              <a href=\"../../src/Admin/process_delete_course.php?id={$row["id"]}\" class='btn btn-outline-danger'>
