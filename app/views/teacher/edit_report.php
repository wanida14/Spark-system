    ...
    <div class="container pt-4">
      <div class="row">
        ...
        <div class="col-sm-10 ">
          ...
          <form method="post" action="../../src/Teacher/process_update_report.php" enctype="multipart/form-data" style="margin:40px 20px;">
            <div class="form-group col-sm-4">
              ...
              <input type="hidden" name="id" value="<?php echo $data_report["student_id"]; ?>">
